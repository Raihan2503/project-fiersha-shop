...
// Route::post('/keranjang/{id_produk}', [HomeController::class, 'beli'])->name('keranjang.beli');
...
Route::get('/transaksi/success', [Transaksi::class, 'success'])->name('transaksi-success');
